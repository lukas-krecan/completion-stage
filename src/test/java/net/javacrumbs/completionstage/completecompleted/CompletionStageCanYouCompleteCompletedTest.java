...
public class CompletionStageCanYouCompleteCompletedTest extends AbstractCanYouCompleteAlreadyCompletedTest {

    private final CompletionStageFactory completionStageFactory = new CompletionStageFactory(Runnable::run);
